...
# Unify the flash-card section name everywhere.
...
# PDF extraction: keep normal English vocabulary and exclude only prepositions,
# conjunctions, obvious person/place names, and structural/noise tokens.

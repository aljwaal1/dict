...
class MorePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: ListView(padding: const EdgeInsets.all(16), children: [
      SettingsTile(icon: Icons.auto_awesome_rounded, title: 'استوديو AI للكتاب', subtitle: 'PDF أو كاميرا أو صور • استخراج الكلمات مع حفظ تلقائي', onTap: () => push(context, BookLabPage(store: store))),
...
class _BookLabPageState extends State<BookLabPage> {
  ...
  Future<void> saveSelected() async {
    ...
    await _clearDraft();
    if (mounted) snack(context, added == 0 ? 'تم تحديث الكلمات الموجودة دون تكرار' : 'تم حفظ ' + added.toString() + ' كلمة جديدة في القاموس');
  }
        ...
        Expanded(
          child: candidates.isEmpty
              ? Center(child: Padding(padding: const EdgeInsets.all(28), child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  const SizedBox(height: 14),
                  const Text('حوّل كتابًا أو صورة إلى قاموس بالذكاء الاصطناعي', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900)),
                  const SizedBox(height: 8),
                  const Text('استخدم PDF أو صوّر صفحة مباشرة أو اختر صورًا من الهاتف. يستخرج النص محليًا، ينظف المفردات، ويترجمها مع حفظ العمل أولًا بأول.', textAlign: TextAlign.center, style: TextStyle(height: 1.5, color: Color(0xff64748b))),
                ])))
              : ListView.builder(
      ...
      slivers: [
        ...
        SliverPadding(
          ...
          sliver: SliverList.list(children: [
            ...
            Row(children: [
              Expanded(child: QuickCard(icon: Icons.auto_awesome_rounded, title: 'استوديو AI للكتاب', subtitle: 'PDF أو كاميرا أو صور', onTap: () => push(context, BookLabPage(store: store)))),
              const SizedBox(width: 12),
